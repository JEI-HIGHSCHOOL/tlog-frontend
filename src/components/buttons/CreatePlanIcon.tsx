...
import iconCss from "@/styles/plan.module.css"

export default function CreatePlanIcon() {
  return (
    <div className={iconCss.overlay + " transform hover:-translate-y-2 transition duration-200 animate-bounce ease-in cursor-pointer"}>
          <div className={iconCss.overlaybg}/>
